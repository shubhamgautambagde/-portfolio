  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>Anushri Tiwari</h2>
        <p className='i_am_a'>I am a&nbsp;<span class="typewriter"></span></p>
        
        <div className="flex1">
        <p className='follow_me'>follow me: </p>
        <div className="logos">
        <a href="https://github.com/ROCKANU" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="https://www.linkedin.com/in/anushritiwari/" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
        <a href="https://leetcode.com/u/2003anushritiwari/" target="_blank" rel="noreferrer"><img src={leetcodes} alt=""></img></a>
        </div>
        </div>
        <div className="flex1">
        <a href="mailto:anushritiwari123@gmail.com"><button className='buttonc'>E-Mail Me</button></a>
        <button onClick={() => window.open("https://drive.google.com/file/d/18VlEjKh8WwHhoJZpIaDAmDakuhNHMI2-/view?usp=drive_link")} className='buttonb'>Resume</button>
        </div>
      </div>
      ...
      {/* Your profile image */}
  <img className='profile_image' src={require('./images/image2.png')} alt="Profile"/>
